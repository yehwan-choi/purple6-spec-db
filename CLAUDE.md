...
| 담당자 | `createDistributorContact`, `updateDistributorContact`, `deleteDistributorContact` |
| 연결 | `addMaterialToDistributor`, `removeMaterialFromDistributor`, `addProjectToDistributor`, `removeProjectFromDistributor` |
...
주요 타입: `Material`, `MaterialCategory`, `Distributor`, `DistributorContact`, `DistributorType`, `MaterialDistributorLink`, `Project`, `ProjectSpec`
...
| `/distributors/[id]` | Dynamic | 서버 렌더링 상세 페이지 (인라인 편집, 담당자·마감재·프로젝트 탭) |
